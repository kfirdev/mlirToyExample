...
// RUN: clang -c arrays_to_llvm_main.c 
// RUN: clang arrays_to_llvm_main.o %t -o b.out
...
// CHECK: 2
func.func @test_extractOp(%arg0: !arrays.array<3,!primitive.int<32>>) -> !primitive.int<32> {
...
// CHECK: [1,1,3] 
func.func @test_insertOp(%arg0: !arrays.array<3,!primitive.int<32>>) -> !arrays.array<3,!primitive.int<32>> {
  %idx = index.constant 1
